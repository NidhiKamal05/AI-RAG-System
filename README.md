...
[]
(https://colab.research.google.com/github/NidhiKamal05/AI-RAG-System/blob/main/notebook.ipynb)
...
Raw Data → Cleaning → Chunking → Embeddings → ChromaDB
                                                  ↓
Query → Embedding → Retrieval → Guard → Final Results
...
☁️ Google Colab + Drive Integration
...
Query → Embedding → Retrieval → Guard → Output
...
with your actual GitHub repo link to make the Colab button work ✅
